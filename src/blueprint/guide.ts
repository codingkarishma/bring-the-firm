...
export const bringTheFirmGuide = {
	intro:
		"Let's build your Bring the firm opportunity format. I just have a few quick questions.",
	questions: [
		{
			id: 'existing-program',
			type: 'choice',
			...
			helpText:
				'Tell us whether this format should support an established Bring the Firm motion or introduce the workflow from scratch.',
			options: [
		...
		},
		{
			...
			helpText:
				'Choose when the opportunity format should check colleague availability before recommending them for a client meeting.',
			options: [
